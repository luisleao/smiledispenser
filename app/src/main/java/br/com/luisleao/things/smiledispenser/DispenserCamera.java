...
/**
 * Created by luisleao on 07/05/17.
 */

public class DispenserCamera {

    private static final String TAG = DispenserCamera.class.getSimpleName();



    private static final int IMAGE_WIDTH = 320; //320;
    private static final int IMAGE_HEIGHT = 240; //240;
    ...
    private DispenserCamera() {
    }

    private static class InstanceHolder {
        private static DispenserCamera mCamera = new DispenserCamera();
    }

    public static DispenserCamera getInstance() {
